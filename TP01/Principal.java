...
//            livro1.setNome("Novo nome do filme 1");
//            if (arquivoFilmes.update(livro1))
//                System.out.println("Filme de ID " + livro1.getId() + " alterado para: " + livro1.getNome());
//            else
//                System.out.println("Não foi possível atualizar o filme de ID " + livro1.getId());
//
//            // Seção: Atualização de Filme 2
//            livro2.setNome("Novo nome do filme 2");
//            if (arquivoFilmes.update(livro2))
//                System.out.println("Filme de ID " + livro2.getId() + " alterado para: " + livro2.getNome());
//            else
//                System.out.println("Não foi possível atualizar o filme de ID " + livro2.getId());
//
//            // Seção: Atualização de Filme 3
//            livro3.setNome("Novo nome do filme 3");
//            if (arquivoFilmes.update(livro3))
//                System.out.println("Filme de ID " + livro3.getId() + " alterado para: " + livro3.getNome());
//            else
//                System.out.println("Não foi possível atualizar o filme de ID " + livro3.getId());
//
//            // Seção: Atualização de Filme 4
//            livro4.setNome("Novo nome do filme 4");
//            if (arquivoFilmes.update(livro4))
//                System.out.println("Filme de ID " + livro4.getId() + " alterado para: " + livro4.getNome());
//            else
//                System.out.println("Não foi possível atualizar o filme de ID " + livro4.getId());
//
//            // Seção: Atualização de Filme 5
//            livro5.setNome("Novo nome do filme 5");
//            if (arquivoFilmes.update(livro5))
//                System.out.println("Filme de ID " + livro5.getId() + " alterado para: " + livro5.getNome());
//            else
//                System.out.println("Não foi possível atualizar o filme de ID " + livro5.getId());
//
//            // Seção: Atualização de Filme 6
//            livro6.setNome("Novo nome do filme 6");
//            if (arquivoFilmes.update(livro6))
//                System.out.println("Filme de ID " + livro6.getId() + " alterado para: " + livro6.getNome());
//            else
//                System.out.println("Não foi possível atualizar o filme de ID " + livro6.getId());
            ...
            if (arquivoFilmes.delete(livro1.getId()))
                ...
                System.out.println("Filme \"" + livro1.getNome() + "\" de ID " + idLivro1 + " não foi possível excluir!");
            ...
            if (arquivoFilmes.delete(livro2.getId()))
                ...
                System.out.println("Filme \"" + livro2.getNome() + "\" de ID " + idLivro2 + " não foi possível excluir!");
            ...
            if (arquivoFilmes.delete(livro3.getId()))
                ...
                System.out.println("Filme \"" + livro3.getNome() + "\" de ID " + idLivro3 + " não foi possível excluir!");
            ...
            if (arquivoFilmes.delete(livro4.getId()))
                ...
                System.out.println("Filme \"" + livro4.getNome() + "\" de ID " + idLivro4 + " não foi possível excluir!");
            ...
            if (arquivoFilmes.delete(livro5.getId()))
                ...
                System.out.println("Filme \"" + livro5.getNome() + "\" de ID " + idLivro5 + " não foi possível excluir!");
            ...
            if (arquivoFilmes.delete(livro6.getId()))
                ...
                System.out.println("Filme \"" + livro6.getNome() + "\" de ID " + idLivro6 + " não foi possível excluir!");
